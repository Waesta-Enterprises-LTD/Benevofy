...
class Member(models.Model):
    ...
    events = models.ManyToManyField('Events.PersonalEvent', blank=True, related_name='events')
    email_verified = models.BooleanField(default=False)
    verification_code = models.CharField(max_length=500, null=True, blank=True)
    current_mode = models.CharField(max_length=10, choices=[("Member", "Member"), ("Admin", "Admin"), ("Personal", "Personal")], default="Personal")
