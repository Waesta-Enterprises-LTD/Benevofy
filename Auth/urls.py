...
from .views import login_member, login_admin, reset_password, send_reset_code, logout_user, change_password, register, verify_email, switch_association, switch_to_admin, switch_to_member, register_exists, switch_to_personal_account
...
urlpatterns = [
    ...
    path('register-exists/<registration_code>/', register_exists, name='register-exists'),
